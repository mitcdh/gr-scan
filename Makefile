...
VERSION=2015112301
CXXFLAGS=-DVERSION="\"gr-scan $(VERSION)\"" -std=c++11 -Wall -lgnuradio-blocks -lgnuradio-osmosdr -lgnuradio-filter -lgnuradio-fft -lgnuradio-pmt -lgnuradio-runtime -lboost_system -O2 -s -Wno-unused-function
